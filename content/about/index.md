...
title: "About"
layout: "about"
description: "iOS developer, Swift enthusiast, speaker e musicista. La storia di come ho iniziato a premere tasti a caso su una tastiera e ho finito per distribuire app a milioni di persone."
---

## ... or how I started pushing random keys on a keyboard and ended up delivering apps to millions of people.

{{< figure src="/images/about/Old-avatar.jpeg" caption="Me, back in the days" >}}
...
{{< figure src="/images/about/my-first-business-card.jpeg" caption="My first business card" >}}

## Synesthesia

In 2012 I started my first "real" job at [Synesthesia](https://synesthesia.it) — and I've never left. It's quite uncommon for people in our industry to stay in the same place for so long, but Syn gave me the chance to work on so many different projects across so many areas: sports, agriculture, finance, management. And I'm not even mentioning the wonderful people I had the chance to meet and work with.
...
{{< figure src="/images/about/bug-is-here.jpeg" caption="The bug is here, I swear" >}}
...
In 2018 we brought a new conference to Torino for Swift developers — [Swift Heroes](https://www.swiftheroes.com). I finally got my chance to get on stage (right after an unexpected panic attack a few minutes before my slot) with a talk about RxSwift.
...
{{< figure src="/images/about/first-talk.jpeg" caption="My first talk at Swift Heroes, 2018" >}}
...
{{< figure src="/images/about/droidcon.jpeg" caption="Hosting Droidcon Italy" >}}
...
{{< figure src="/images/about/interviewing.jpeg" caption="Interviewing speakers at Swift Heroes" >}}

## Free Time

When I'm not coding, I enjoy playing music — drums and guitar are my favorites.

{{< figure src="/images/about/Drums.jpeg" caption="Drums — my favorite stress relief" >}}

In summer I like to jump on my e-MTB and climb mountains, enjoying the ride all the way back downhill.

{{< figure src="/images/about/IMG_1141.jpeg" caption="Somewhere up in the mountains with my e-MTB" >}}
...
{{< figure src="/images/about/wedding.jpeg" caption="Riding an ostrich in South Africa" >}}
